...
<body>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Romance <span class="sr-only">(current)</span>
  ...
  <div class="bookDisplay p-5 ">
    ...
    $stmt = $db->prepare("SELECT * FROM book WHERE GenreID = 2");
    $stmt->execute();
